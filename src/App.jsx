...
const { scene } = useGLTF('/ofl0teWSYkR6upWkY6VyX_model.glb', true);
...
</group>  {/* Cinematic contact shadows */}
<ContactShadows
position={[0, -0.45, 0]}
rotation={[-Math.PI / 2, 0, 0]}
opacity={0.4}
...
/>  
<directionalLight position={[-5, 2, -5]} intensity={0.6} />  <Environment variant={PRODUCT_VARIANTS[variantIndex]} locked={locked} />    
    <CameraAuthority />    <Shoe    
